...
interface ExtendedSidebarProps extends SidebarProps {
  ...
  // Add model-related properties
  _availableModels: ModelInfo[] | null;
  _selectedModelId: string | null;
  _onModelChange: (modelId: string | null) => void;
}
...
const Sidebar: React.FC<ExtendedSidebarProps> = ({
  ...
  const [globalIgnorePatterns, /*REMOVE: setGlobalIgnorePatterns*/] = useState("");
  const [localIgnorePatterns, /*REMOVE: setLocalIgnorePatterns*/] = useState("");
  ...
  return (
    <div className={styles.sidebar} style={{ width: `${sidebarWidth}px` }} data-testid="sidebar">
      ...
      <IgnorePatterns 
        ...
        onClose={handleCloseIgnorePatterns}
